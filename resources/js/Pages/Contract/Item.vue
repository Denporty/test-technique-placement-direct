<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="my-2">
            <Checkbox :disabled="$page.props.auth.user.administrator || props.contract.data.is_sign" label="Signer" name="is_sign" v-model:checked="form.is_sign" :value="form.is_sign" :message="form.errors.is_sign"/>
        </div>
